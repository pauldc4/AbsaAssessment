...
namespace TelephoneDirectory
{
    public class Startup
    {
        ...
        {
            services.AddEntityFrameworkSqlite().AddDbContext<TelephoneDirectoryContext>();
            ...
            services.AddTransient<IRepository<PhoneBook, int>, GenericRepository<PhoneBook, int>>();
            services.AddTransient<IRepository<Entry, int>, GenericRepository<Entry, int>>();
